DROP TABLE IOTUSER.PRODUCTDB;

CREATE TABLE IOTUSER.PRODUCTDB(
...
INSERT INTO IOTUSER.PRODUCTDB ("NAME",PRICE,TAX,ADDED_DT,EXPIRY_DT,QUANTITY,CATEGORY,LOCATION)
VALUES 
...
SELECT * FROM IOTUSER.PRODUCTDB;

SELECT * FROM IOTUSER.PRODUCTDB WHERE "NAME" LIKE '%Google%'
