    ...
    <div class="container d-flex flex-wrap">
      ...
      <ul class="nav">
          <%
              ...
              if(account == null){
          %>
            <li class="nav-item"><a href="/IotBay/shop.jsp" class="nav-link link-dark px-2">Shop</a></li>
            <li class="nav-item"><a href="/IotBay/orders.jsp" class="nav-link link-dark px-2">My Orders</a></li>
            <li class="nav-item"><a href="cart.jsp" class="nav-link link-dark px-2">Cart <span class="badge badge-danger">${cart_list.size()}</span> </a></li>
